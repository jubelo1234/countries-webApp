function Card({data, theme, setHom, setCountry}) {
    ...
    return (
        <div onClick={handleClick} className="w-[85%] max-w-[300px] ttlap:max-w-[340px] shadow-3xl dark:shadow-none bg-white dark:bg-dBlue overflow-hidden rounded-[5px]">
            <div className="w-full h-fit  sm:w-[300px] ttlap:w-[340px] sm:h-[200px]">
